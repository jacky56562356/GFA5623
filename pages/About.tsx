...
const About: React.FC = () => {
  ...
  return (
    <div className="bg-gfa-warmWhite min-h-screen">
      ...
      <section className="py-24 px-6 relative bg-gfa-warmWhite">
        ...
        <div className="container-gfa grid grid-cols-1 md:grid-cols-2 gap-12 relative z-10">
          ...
          <div className="bg-gfa-inkBlack p-12 border border-gfa-inkBlack rounded-sm shadow-xl text-white relative overflow-hidden">
            ...
            <h3 className="text-2xl font-bold font-serif text-gfa-gold mb-6 relative z-10">{a.vision.title}</h3>
      ...
      <section className="py-24 bg-white">
        <div className="container-gfa grid grid-cols-1 md:grid-cols-2 gap-16 items-center">
          ...
          <div className="order-1 md:order-2">
             ...
             <Link to="/career-access" className="btn-primary !h-12 !text-[12px] shadow-md">{ui.buttons.explore}</Link>
          </div>
        </div>
      </section>
      ...
      {a.collaboration && (
        <section className="py-24 bg-gfa-warmWhite border-t border-gfa-border relative">
           ...
           <div className="container-gfa">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
                 {a.resourceExchange.categories.map((cat: any, i: number) => (
                    <div key={i} className="bg-gfa-warmWhite p-8 border border-gfa-border rounded-sm hover:border-gfa-gold transition-all group hover:shadow-lg">
      ...
      <section className="py-32 bg-white border-t border-gfa-border text-center relative overflow-hidden">
        ...
        <div className="container-gfa relative z-10">
           ...
           <div className="w-full max-w-4xl mx-auto aspect-[2/1] bg-gfa-inkBlack border border-gfa-border rounded-sm flex items-center justify-center relative shadow-2xl overflow-hidden group">
              ...
              <div className="absolute top-1/4 left-1/4 w-3 h-3 bg-gfa-gold rounded-full shadow-[0_0_10px_#C9A24D] animate-pulse"></div>
              <div className="absolute top-1/3 right-1/4 w-3 h-3 bg-gfa-gold rounded-full shadow-[0_0_10px_#C9A24D] animate-pulse delay-100"></div>
              <div className="absolute bottom-1/3 left-1/2 w-3 h-3 bg-gfa-gold rounded-full shadow-[0_0_10px_#C9A24D] animate-pulse delay-200"></div>
           </div>
        </div>
      </section>
