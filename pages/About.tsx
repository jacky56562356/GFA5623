          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-start">
            <div>
              ...
              <div className="flex items-center gap-4 pt-6 border-t border-gfa-border">
                <img src="/images/ChatGPT_Image_2026年5月6日_18_06_52.png" alt="Jack Liu" className="w-16 h-16 rounded-full object-cover border-2 border-[#C9A84C]" />
                <div>
            ...
            <div className="space-y-4">
              ...
              <div className="grid grid-cols-2 gap-4">
                ...
                <img src="/images/ChatGPT_Image_2026年5月6日_18_12_27.png" alt="Children film production" className="w-full h-44 object-cover rounded-2xl" />
              </div>
            </div>
          </div>
        </div>
      ...
      <section className="py-24 bg-[#F9F7F4]">
        <div className="container-gfa max-w-6xl mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            {(isZh ? [
              { img: '/images/ChatGPT_Image_2026年5月6日_18_12_27.png', title: '电影专业毕业生', desc: '来自USC、UCLA、Chapman等院校的应届毕业生，寻求进入行业的第一步。' },
              { img: '/images/ChatGPT_Image_2026年5月6日_18_06_00.png', title: '新晋独立导演', desc: '有创作愿景但缺乏发行渠道和行业资源的独立创作者。' },
              { img: '/images/ChatGPT_Image_2026年5月6日_18_06_52.png', title: '6-17岁青少年', desc: '通过夏令营、制作项目和比赛探索创作潜能的年轻人。' },
              { img: '/images/ChatGPT_Image_2026年5月6日_18_08_23.png', title: '特殊需求儿童', desc: '自闭症、抑郁症等特殊需求儿童，通过电影艺术疗法找到疗愈。' },
            ] : [
              { img: '/images/ChatGPT_Image_2026年5月6日_18_12_27.png', title: 'Film Graduates', desc: 'Recent graduates from USC, UCLA, Chapman seeking their industry breakthrough.' },
              { img: '/images/ChatGPT_Image_2026年5月6日_18_06_00.png', title: 'Emerging Directors', desc: 'Independent creators with vision who lack distribution channels and industry resources.' },
              { img: '/images/ChatGPT_Image_2026年5月6日_18_06_52.png', title: 'Youth Ages 6–17', desc: 'Young people exploring creative potential through camps, production projects, and competitions.' },
              { img: '/images/ChatGPT_Image_2026年5月6日_18_08_23.png', title: 'Special Needs Youth', desc: 'Children with autism or depression finding healing through film arts therapy programs.' },
            ]).map(item => (
