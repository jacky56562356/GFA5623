    ...
    <div className="font-sans pb-3 bg-[#F5F2EE] min-h-screen">
      ...
      <section className="bg-gfa-inkBlack text-white py-3 px-4 text-center">
        <h1 className="text-3xl md:text-5xl font-bold font-serif mb-3">
          {"Donate Gear for Employment Support"}
        </h1>
        ...
        <div className="container-gfa max-w-5xl mx-auto">
          <div className="grid md:grid-cols-3 gap-4">
            <div className="bg-white p-8 rounded-3xl shadow-sm border border-gfa-border text-center">
              ...
              <h3 className="text-xl font-bold text-gfa-inkBlack mb-3">{"Empower Filmmakers"}</h3>
              <p className="text-gfa-slate text-sm leading-relaxed font-light">
                {"Donated gear directly supports GFA's hands-on training sets, giving marginalized creators access to professional tools."}
              </p>
            </div>
            <div className="bg-white p-8 rounded-3xl shadow-sm border border-gfa-border text-center">
              <div className="w-16 h-16 bg-[#C9A84C]/10 rounded-full flex items-center justify-center mx-auto mb-3 text-[#C9A84C]">
              ...
              <h3 className="text-xl font-bold text-gfa-inkBlack mb-3">{"Create Real Jobs"}</h3>
              <p className="text-gfa-slate text-sm leading-relaxed font-light">
                {"Trainees use your gear to build portfolios and qualify for union jobs or freelance work, driving direct employment."}
              </p>
            </div>
            <div className="bg-white p-8 rounded-3xl shadow-sm border border-gfa-border text-center">
              <div className="w-16 h-16 bg-[#C9A84C]/10 rounded-full flex items-center justify-center mx-auto mb-3 text-[#C9A84C]">
              ...
              <h3 className="text-xl font-bold text-gfa-inkBlack mb-3">{"Tax Deductible"}</h3>
              <p className="text-gfa-slate text-sm leading-relaxed font-light">
                {"As a registered non-profit, GFA provides tax receipts for the fair market value of accepted equipment donations."}
              </p>
            </div>
          </div>
        </div>
          ...
          <div className="relative border-l-2 border-[#C9A84C]/30 ml-4 md:ml-1/2 pl-6 md:pl-0 space-y-3">
            <div className="md:flex items-center justify-between w-full">
              <div className="md:w-5/12 text-left md:text-right pr-6">
                <h4 className="text-lg font-bold text-gfa-inkBlack">{"1. Submit Intention"}</h4>
                <p className="text-sm text-gfa-slate font-light mt-1">{"Fill out the form below with photos and condition details of your gear."}</p>
              </div>
            ...
            <div className="md:flex items-center justify-between w-full">
              ...
              <div className="md:w-5/12 pl-0 md:pl-6 text-left">
                <h4 className="text-lg font-bold text-gfa-inkBlack">{"2. GFA Evaluation"}</h4>
                <p className="text-sm text-gfa-slate font-light mt-1">{"We assess the equipment to ensure it fits our training or production programs."}</p>
              </div>
            </div>

            <div className="md:flex items-center justify-between w-full">
              <div className="md:w-5/12 text-left md:text-right pr-6">
                <h4 className="text-lg font-bold text-gfa-inkBlack">{"3. Shipping / Drop-off"}</h4>
                <p className="text-sm text-gfa-slate font-light mt-1">{"Once approved, ship the gear to our HQ or drop it off locally."}</p>
              </div>
              <div className="absolute left-[-5px] md:left-1/2 md:-ml-[5px] w-3 h-3 bg-[#C9A84C] rounded-full mt-1.5 md:mt-0"></div>
              <div className="md:w-5/12 pl-6 hidden md:block"></div>
            </div>
            ...
            <div className="md:flex items-center justify-between w-full">
              ...
              <div className="absolute left-[-5px] md:left-1/2 md:-ml-[5px] w-3 h-3 bg-[#C9A84C] rounded-full mt-1.5 md:mt-0"></div>
              <div className="md:w-5/12 pl-0 md:pl-6 text-left">
                <h4 className="text-lg font-bold text-gfa-inkBlack">{"4. Receipt & Acknowledgment"}</h4>
                <p className="text-sm text-gfa-slate font-light mt-1">{"We inventory the gear and send your official tax receipt and acknowledgment."}</p>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="container-gfa max-w-4xl mx-auto px-4">
          <div className="text-center mb-5">
            ...
            <p className="text-gfa-slate font-light">
              {"Please fill out the details of the equipment you wish to donate."}
            </p>
          </div>
                  ...
                  <div>
                    ...
                    <div className="flex gap-4">
                      <label className="flex items-center gap-2 cursor-pointer">
                        ...
                        />
                        <span className="text-sm font-medium">{"Mail / Courier"}</span>
                      </label>
                      <label className="flex items-center gap-2 cursor-pointer">
                        <input
                          type="radio"
                          ...
                          className="text-[#C9A84C] focus:ring-[#C9A84C]"
                        />
                        <span className="text-sm font-medium">{"In-person Drop-off"}</span>
                      </label>
                    </div>
                  </div>
                  <div>
                    ...
                    <input
                      ...
                      onChange={handleChange}
                      placeholder={"Where will the gear be shipped from?"}
                      className="w-full bg-gfa-warmWhite border border-gfa-border rounded-lg px-4 py-3 focus:outline-none focus:border-[#C9A84C]"
                    />
                  </div>
                  <div className="bg-blue-50 p-4 rounded-xl border border-blue-100 mt-4">
                     <p className="text-sm text-blue-800 font-light">
                       {"GFA Receiving Address (Provided upon assessment approval)"}
                     </p>
                  </div>
                </div>
              </div>
                ...
                <div className="space-y-3">
                  ...
                  <div>
                    ...
                    <textarea
                      ...
                      onChange={handleChange}
                      placeholder={"Any additional context about the equipment History, missing parts, battery health, etc."}
                  ...
                  <div>
                    ...
                    <p className="text-xs text-gfa-slate mt-2">
                       {"Supported formats: JPG, PNG. Help us evaluate the condition."}
                    </p>
                  ...
                  <label className="flex items-start gap-4 p-4 rounded-xl border border-gfa-border hover:bg-gfa-warmWhite cursor-pointer transition-colors">
                    ...
                    <div>
                      <p className="font-bold text-sm text-gfa-inkBlack mb-1">
                        {"I would like GFA to assess this donation for tax-deduction purposes."}
                      </p>
