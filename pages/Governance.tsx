  ...
  return (
    <div className="py-32 max-w-7xl mx-auto px-4">
      ...
      <div className="mb-24 bg-gfa-darkGray p-12 border border-gfa-gold/10 relative overflow-hidden">
        ...
        <h3 className="text-2xl font-black mb-8 gold-gradient uppercase tracking-tight">Section 1 — Our Role (Legal Positioning)</h3>
        <div className="space-y-6 text-gfa-gray leading-loose text-base uppercase tracking-wider font-medium">
          <p>
            GFA is an independent nonprofit standards and certification organization.
            We establish voluntary industry standards to improve safety, transparency, and professionalism across auditions, competitions, showcases, and training programs involving minors.
          </p>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 pt-4">
            <div className="p-6 bg-gfa-black border border-white/5">
              <span className="text-gfa-gold font-black block mb-2">NON-REGULATORY</span>
              <p className="text-xs">GFA does not act as a government regulator. Participation in GFA certification is voluntary.</p>
            </div>
            <div className="p-6 bg-gfa-black border border-gfa-gold/30">
              <span className="text-gfa-gold font-black block mb-2">ECOSYSTEM ACCESS</span>
              <p className="text-xs">Only authorized programs may be listed, promoted, or supported within the GFA ecosystem.</p>
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="mb-24">
        <h3 className="text-2xl font-black mb-12 text-center uppercase tracking-widest gold-gradient">Section 2 — Core Principles</h3>
      ...
      <div className="bg-gfa-gold p-16 text-gfa-black">
        ...
        <p className="text-lg font-bold mb-10 leading-relaxed uppercase tracking-tight">
          To protect families and ensure credibility: Any audition, competition, showcase, or training activity involving minors that wishes to be listed, recruit, or use branding within GFA <span className="underline decoration-4">must obtain GFA Authorization</span>.
        </p>
        <div className="grid grid-cols-2 md:grid-cols-3 gap-4 mb-12">
          {['Listed on GFA', 'Recruit through GFA', 'Use GFA Branding', 'Receive GFA Support', 'Access Talent Network'].map(item => (
