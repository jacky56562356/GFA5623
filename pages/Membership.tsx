            ...
            <div className="sticky top-24 space-y-4">
              ...
              <div className="p-10 bg-gfa-inkBlack text-white rounded-[32px] shadow-2xl border border-white/5 relative overflow-hidden group">
                <div className="absolute inset-0 opacity-20 group-hover:scale-110 transition-transform duration-1000">
                  <img loading="lazy"  src="https://wsrv.nl/?url=images.unsplash.com%2Fphoto-1521791136364-798a730bb361%3Fq%3D80%26w%3D2070%26auto%3Dformat%26fit%3Dcrop&w=1200&output=webp" alt="Network" className="w-full h-full object-cover grayscale"  width="1200" height="800"  onError={(e) => { e.currentTarget.src = "https://placehold.co/1200x800/eeeeee/999999?text=Image+Not+Found"; }} />
                </div>
