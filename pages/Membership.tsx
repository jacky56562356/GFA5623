...
const Membership: React.FC = () => {
  ...
  return (
    <div className="py-32 max-w-7xl mx-auto px-4">
      ...
      <div className="mb-32">
        <h3 className="text-2xl font-black mb-12 uppercase tracking-widest text-center gold-gradient">{t.membership.talentTitle}</h3>
      ...
      <div className="mb-32">
        <h3 className="text-2xl font-black mb-12 uppercase tracking-widest text-center gold-gradient">{t.membership.orgTitle}</h3>
      ...
      <div className="bg-gfa-gold p-16 text-center text-gfa-black">
        <h3 className="text-3xl font-black mb-6 uppercase tracking-tight">{t.membership.entTitle}</h3>
        <p className="max-w-2xl mx-auto mb-12 font-medium">{t.membership.entDesc}</p>
