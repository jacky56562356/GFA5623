  ...
  return (
    <div className="font-sans pb-6">
      ...
      <section className="py-6 bg-[#F5F2EE]">
        <div className="container-gfa max-w-4xl mx-auto px-4">
           ...
           <div className="space-y-4">
              {/* News Item 1 */}
              <div className="bg-white p-8 rounded-3xl border border-gray-100 flex flex-col md:flex-row gap-4 hover:shadow-md transition-shadow">
                 ...
                 <div className="md:w-2/3 flex flex-col justify-center">
                    ...
                    <p className="text-gfa-slate font-light text-sm mb-3">
      ...
      <section className="py-5 bg-gfa-inkBlack text-white">
        <div className="container-gfa max-w-4xl mx-auto px-4 text-center">
           <h2 className="text-3xl font-bold font-serif mb-3">{isEn ? "Media Assets & Press Kit" : "媒体素材与资料包"}</h2>
           <p className="text-white/70 font-light max-w-2xl mx-auto mb-4">
             {isEn 
