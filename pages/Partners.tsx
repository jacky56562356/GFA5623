  ...
  return (
    <div className="bg-gfa-warmWhite pt-4 pb-4 px-6 min-h-screen relative overflow-hidden">
      ...
      <div className="container-gfa relative z-10">
        ...
        {/* Filters */}
        <div className="bg-white p-8 md:p-12 mb-5 flex flex-wrap gap-3 border border-gfa-border items-end rounded-[40px] shadow-2xl animate-fade-up">
          <div className="flex-grow min-w-[240px]">
            <label className="block text-[10px] text-gfa-slate font-bold uppercase tracking-[0.3em] mb-3 opacity-60">{p.catLabel}</label>
            <select 
          ...
          <div className="flex-grow min-w-[240px]">
            <label className="block text-[10px] text-gfa-slate font-bold uppercase tracking-[0.3em] mb-3 opacity-60">{p.countryLabel}</label>
            <select 
          ...
          <div className="ml-auto text-xs text-gfa-gold font-black uppercase tracking-[0.4em] self-center pt-4">
            ...
            <div key={m.id} className="bg-white p-12 rounded-[40px] border border-gfa-border shadow-xl hover:shadow-2xl hover:scale-[1.02] hover:border-gfa-gold transition-all duration-500 group relative overflow-hidden">
              ...
              <div className="flex justify-between items-start mb-3 relative z-10">
                <div className="w-20 h-20 bg-gfa-warmWhite rounded-2xl flex items-center justify-center border border-gfa-border group-hover:border-gfa-gold/30 transition-all duration-500 shadow-inner">
                  <img fetchpriority="high"  src={m.logo} alt={m.name} className="w-12 h-12 object-cover grayscale opacity-40 group-hover:grayscale-0 group-hover:opacity-100 transition-all duration-700"  width="1200" height="800"   />
                </div>
              ...
              <p className="text-gfa-gold font-bold text-sm mb-4 font-serif italic">{m.benefit}</p>
              
              <p className="text-gfa-slate text-sm mb-5 font-light italic opacity-80">
                {m.city}, {m.country}
              </p>
              
              <div className="pt-4 border-t border-gfa-border/50 text-[10px] font-bold uppercase tracking-[0.3em] text-gfa-slate/40">
