...
const Safeguarding: React.FC = () => {
  ...
  return (
    <div className="bg-gfa-navy min-h-screen relative bg-[#0B0C10]">
      {/* Background Texture */}
      ...
      <div className="pt-40 pb-32 px-6 relative z-10">
        <div className="max-w-7xl mx-auto">
          ...
          <header className="mb-20 text-center max-w-5xl mx-auto">
            <div className="inline-flex items-center gap-3 px-4 py-1.5 border border-red-500/30 text-red-500 text-[9px] font-black uppercase tracking-[0.5em] mb-8 bg-red-500/5 rounded-sm shadow-[0_0_15px_rgba(239,68,68,0.2)]">
              <span className="w-1.5 h-1.5 rounded-full bg-red-500 animate-pulse"></span>
              {ui.oversightBadge}
            </div>
            <h1 className="mb-10 text-white uppercase text-2xl md:text-4xl tracking-tighter leading-none font-black font-serif drop-shadow-lg">
              {sg.title}
            </h1>
          ...
          <section className="mb-32">
            <div className="bg-gradient-to-b from-[#161b22] to-[#0d1117] border border-white/10 p-10 md:p-16 shadow-2xl relative overflow-hidden rounded-sm">
              <div className="absolute top-0 left-0 w-1.5 h-full bg-red-600 shadow-[0_0_20px_rgba(220,38,38,0.5)]"></div>
              ...
              <div className="max-w-3xl mx-auto text-center relative z-10">
                ...
                <form onSubmit={handleVerify} className="flex flex-col md:flex-row gap-4 mb-6">
                  <input 
                    ...
                    className="flex-grow bg-black/40 border border-white/10 p-4 text-white font-mono text-xs uppercase tracking-widest outline-none focus:border-gfa-gold transition-all shadow-inner"
                  />
                ...
                {verifyResult === 'valid' && (
                  <div className="mt-8 p-6 bg-green-900/20 border border-green-500/30 animate-fade-up backdrop-blur-md">
                ...
                {verifyResult === 'invalid' && (
                  <div className="mt-8 p-6 bg-red-900/20 border border-red-500/30 animate-fade-up backdrop-blur-md">
          ...
          <section className="mb-32">
            <h2 className="text-xl font-black uppercase tracking-[0.3em] text-gfa-gold mb-12 text-center">
              {sg.categories.title}
            </h2>
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
              {Object.entries(sg.categories).filter(([key]) => key !== 'title').map(([key, cat]: [string, any]) => (
                <div key={key} className="bg-white/5 p-10 border border-white/10 group hover:border-gfa-gold/40 transition-all duration-500 flex flex-col h-full rounded-sm hover:bg-white/10 backdrop-blur-sm">
          ...
          <section className="mb-32">
            <div className="bg-gradient-to-br from-red-950/40 to-black border border-red-500/20 p-12 md:p-20 rounded-sm shadow-[0_0_30px_rgba(220,38,38,0.1)]">
              <div className="text-center mb-16">
                <h2 className="text-xl font-black uppercase tracking-[0.3em] text-red-500 mb-6 drop-shadow-md">
                  {sg.redFlags.title}
                </h2>
          ...
          <section className="bg-white/5 p-16 md:p-24 border border-white/10 text-center relative overflow-hidden rounded-sm backdrop-blur-md">
             <div className="absolute inset-0 bg-gradient-to-r from-transparent via-white/5 to-transparent opacity-50"></div>
             <h2 className="text-xl font-black uppercase tracking-[0.3em] text-gfa-gold mb-8 relative z-10">{ui.reportingTitle}</h2>
             <p className="text-[11px] text-slate-400 uppercase tracking-widest mb-14 max-w-4xl mx-auto leading-loose opacity-60 relative z-10">
                {ui.reportingBody}
             </p>
             <div className="flex flex-col sm:flex-row justify-center gap-6 relative z-10">
                <Link to="/complaints" className="bg-red-600 text-white px-12 py-5 font-black uppercase text-[11px] tracking-widest hover:bg-red-700 transition-all shadow-xl hover:shadow-red-900/50">
                  {sg.reportingCta}
                </Link>
