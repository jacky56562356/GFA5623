         ...
         <div className="container-gfa max-w-7xl mx-auto px-6">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-center mb-12">
               ...
               <div className="relative">
                  ...
                  <img src="https://images.unsplash.com/photo-1556761175-5973dc0f32d7?q=80&w=2670&auto=format&fit=crop" referrerPolicy="no-referrer" alt="Partnership" className="relative rounded-[20px] shadow-2xl w-full h-[350px] md:h-[450px] object-cover border border-[#333] z-10" />
               </div>
            </div>
         ...
         <div className="w-full lg:w-[65%] space-y-4">
            ...
            <section id="step2">
               ...
               <div className="mb-6 overflow-hidden rounded-[20px]">
                  <img src="https://images.unsplash.com/photo-1540575467063-178a50c2df87?q=80&w=2670&auto=format&fit=crop" referrerPolicy="no-referrer" alt="Exhibition Area" className="w-full h-48 object-cover opacity-60 border border-[#252525] rounded-[20px]" />
               </div>
               ...
               <div className="space-y-6">
                  ...
                  <div>
                    ...
                    <div className="mb-4 overflow-hidden rounded-[16px]">
                      <img src="https://images.unsplash.com/photo-1551288049-bebda4e38f71?q=80&w=2670&auto=format&fit=crop" referrerPolicy="no-referrer" alt="Digital Display" className="w-full h-32 object-cover opacity-60 border border-[#252525] rounded-[16px]" />
                    </div>
                  ...
                  <div>
                    ...
                    <div className="mb-4 overflow-hidden rounded-[16px] relative">
                      <img src="https://images.unsplash.com/photo-1517604931442-7e0c8ed2963c?q=80&w=2670&auto=format&fit=crop" referrerPolicy="no-referrer" alt="Onsite Billboard" className="w-full h-32 object-cover opacity-60 border border-[#252525] rounded-[16px]" />
                  ...
                  <div>
                    ...
                    <div className="mb-4 overflow-hidden rounded-[16px]">
                      <img src="https://images.unsplash.com/photo-1552596205-db43df024090?q=80&w=2670&auto=format&fit=crop" referrerPolicy="no-referrer" alt="Program Book" className="w-full h-32 object-cover opacity-60 border border-[#252525] rounded-[16px]" />
                    </div>
                    <div className="grid grid-cols-1 gap-3">
            ...
            <section id="step4">
               ...
               <div className="mb-4 overflow-hidden rounded-[16px]">
                  <img src="https://images.unsplash.com/photo-1531259683007-016a7b628fc3?q=80&w=2670&auto=format&fit=crop" referrerPolicy="no-referrer" alt="Gallery" className="w-full h-32 object-cover opacity-60 border border-[#252525] rounded-[16px]" />
               </div>
            ...
            <section id="step5">
               ...
               <div className="mb-6 overflow-hidden rounded-[20px]">
                  <img src="https://images.unsplash.com/photo-1559532297-c6a6f6fcd1bb?q=80&w=2670&auto=format&fit=crop" referrerPolicy="no-referrer" alt="Pitch" className="w-full h-48 object-cover opacity-60 border border-[#252525] rounded-[20px]" />
               </div>
               <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
            ...
            <section id="step6">
               ...
               <div className="mb-6 overflow-hidden rounded-[20px]">
                  <img src="https://images.unsplash.com/photo-1561489422-45de3d015e3e?q=80&w=2670&auto=format&fit=crop" referrerPolicy="no-referrer" alt="Event Package" className="w-full h-48 object-cover opacity-60 border border-[#252525] rounded-[20px]" />
               </div>
               <div className="mb-6 pl-4 border-l-2 border-[#C9A84C] bg-[#1A1A1A] p-4 text-sm text-gray-300 leading-relaxed rounded-r">
                  {isEn 
