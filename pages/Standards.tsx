  ...
  return (
    <div className="py-grid-16 max-w-6xl mx-auto px-4">
      ...
      <div className="mt-grid-20 text-center border-t border-white/10 pt-grid-12">
        <p className="text-gfa-gray micro-text font-black uppercase tracking-[0.4em] opacity-40 max-w-3xl mx-auto leading-loose italic"> Transparency builds trust. Every certified organization adheres to these technical standards. </p>
      </div>
    </div>
  );
};
