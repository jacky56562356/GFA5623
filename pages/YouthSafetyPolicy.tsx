    ...
    <div className="bg-gfa-warmWhite pt-40 pb-4 px-6 min-h-screen">
      <div className="container-gfa">
        ...
        <header className="mb-3 text-center max-w-4xl mx-auto">
          ...
          <p className="text-lg text-gfa-gold font-bold uppercase tracking-[0.2em] mb-3 border-b border-gfa-border pb-4">
            {p.subtitle}
          </p>
        ...
        <div className="space-y-4 max-w-4xl mx-auto">
          {Object.entries(p.sections).map(([key, section]: [string, any]) => (
            <section key={key} className="bg-white p-12 border border-gfa-border relative group hover:border-gfa-gold transition-all rounded-card shadow-sm">
              ...
              <h3 className="text-xl font-bold font-serif text-gfa-inkBlack mb-3 group-hover:text-gfa-gold transition-colors">
                {section.title}
              </h3>
